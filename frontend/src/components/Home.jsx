...
function Home() {
  ...
  return (
    ...
    />
       <button onClick={()=> setIsModalOpen(true)} className='fixed bottom-8 right-6 w-14 h-14 bg-gray-800 text-white text-3xl rounded-full shadow-lg hover:bg-gray-900 flex items-center justify-center'>
                ...
                return (
                  <div className='bg-gray-800 p-4 rounded-lg shadow-md' key={note._id}>
                      ...
                      <div className='flex space-x-2'>
                          <button onClick={()=> handleEdit(note)} className='bg-yellow-600 text-white px-3 py-1 rounded-md hover:bg-yellow-700'>Edit</button>
                          <button onClick={()=>handleDelete(note._id)} className='bg-red-600 text-white px-3 py-1 rounded-md hover:bg-yellow-700'>Delete</button>
                      </div>
                  </div>
                )
            })}
